...
ErrorInputHigherBoundMsgStr db  0Dh,'Higher bound should be greater than lower bound!', 0Ah, '$' 
ErrorInputArrayLengthMsgStr db  0Dh,'Array length should be greater than 0 and not grater than 30!', 0Ah, '$'
                                
InputMsgStr                 db  0Dh,'Input '    
CurrentEl                   db  2 dup(0)
InputMsgStrEnding           db  ' element: $'     
enterStr                    db  0Ah, 0Dh, '$'
